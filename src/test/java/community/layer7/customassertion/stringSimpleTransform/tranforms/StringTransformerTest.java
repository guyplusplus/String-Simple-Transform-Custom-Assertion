...
public class StringTransformerTest {
	...
	public void TestEncodings() {
		...
		try {
			...
			assertEquals(StringTransformer.transformString(StringTransformer.ENCODE_AS_XML10_STRING, "A\u001e&\u001f'\u0020B\ufffeC\u0000D\u000CE"), "A&amp;&apos; BCDE"); // \u001e \u001f \ufffe and \u0000 are removed
			assertEquals(StringTransformer.transformString(StringTransformer.ENCODE_AS_XML11_STRING, "A\u001e&\u001f'\u0020B\ufffeC\u0000D\u000CE"), "A&#30;&amp;&#31;&apos; BCD&#12;E"); // \ufffe and \u0000 are removed
			...
			assertEquals(StringTransformer.transformString(StringTransformer.ENCODE_AS_XML11_STRING, input), " aB\t&amp;\\\u65e5 \u0e01 1");
